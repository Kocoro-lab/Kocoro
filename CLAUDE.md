...
internal/
  daemon/                # ── PRIMARY PRODUCTION PATH ──
    ...
    attachment.go      # Receive remote file attachments — plan §4.3 priority: document_b64 → extracted_text → URL download. Also exposes materializeExtractableFiles (Phase-1 no-op placeholder, §4.6) and daemon-side MaxExtractedTextChars=500_000 truncation guard.
