...
func buildSkillListing(agentSkills []*skills.Skill) string {
	...
	sb.WriteString("This is the current agent's enabled skill set, not the complete inventory of globally installed skills. Other agents can have different enabled skills. Use the kocoro skill and GET /skills when the user asks for the global installed inventory.\n")
