...
### List sessions
- Method: GET
- Path: /sessions[?agent={name}][?scope=all][?project_cwd={path}][?limit={n}][?offset={n}]
- Response: `{"sessions": [{"id", "title", "cwd", "created_at", "updated_at", "msg_count", "agent", "source"?, "kind"?, "in_progress"?, "awaiting_approval"?, "pinned"?, "favorite"?}], "projects": [{"cwd", "updated_at", "session_count"}], "total", "has_more"}`
